...
TEST(gpc_polygon_clip, test_xor_1)
{
    ...
    gpc::gpc_polygon_clip(gpc::gpc_op::GPC_XOR, subject_polygon, clip_polygon,
                          result_polygon);

    gpc::gpc_polygon expected_polygon;
    expected_polygon.add_contour(gpc::gpc_vertex_list({{100, 50},
                                                       {150, 50},
                                                       {150, 150},
                                                       {50, 150},
                                                       {50, 125},
